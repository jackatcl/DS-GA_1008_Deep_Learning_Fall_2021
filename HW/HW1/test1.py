...
#
# print((net_autograd.linear1.weight.grad.data, net.grads['dJdW1']))
# print((net_autograd.linear1.bias.grad.data, net.grads['dJdb1']))
# print((net_autograd.linear2.weight.grad.data, net.grads['dJdW2']))
# print((net_autograd.linear2.bias.grad.data, net.grads['dJdb2']))
#------------------------------------------------
